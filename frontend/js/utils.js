  ...
  <nav class="navbar">
    <div class="max-w-6xl mx-auto px-4 flex items-center justify-between h-14">
      ...
      <a href="/feed" class="flex items-center gap-2 no-underline">
        ...
        <span class="font-bold text-lg hidden md:block" style="color:var(--linkedin-blue)">Mini<span style="color:var(--text-primary)">LinkedIn</span></span>
      </a>

      <!-- Search Bar -->
      <div class="hidden sm:flex flex-1 max-w-xs mx-4 relative">
        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          <svg class="h-4 w-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
        </div>
        <input type="text" id="global-search" class="block w-full pl-10 pr-3 py-1.5 border border-transparent rounded bg-slate-100 text-sm placeholder-gray-500 focus:outline-none focus:bg-white focus:ring-1 focus:ring-blue-500 transition-all" placeholder="Search for people, jobs...">
      </div>
      ...
      <div class="flex items-center gap-1">
        ...
        <a href="/network" class="nav-link ${activePage === 'network' ? 'active' : ''}" id="nav-network">
        ...
        <a href="/companies" class="nav-link ${activePage === 'companies' ? 'active' : ''}" id="nav-companies">
          <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12v18H3V3z"/></svg>
          <span>Companies</span>
        </a>
